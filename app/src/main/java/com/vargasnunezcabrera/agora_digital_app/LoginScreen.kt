    ...
    Scaffold { paddingValues ->
        ...
        { Image( painter = painterResource(id = R.drawable.logo2),
            ...
            { Text( text = "Iniciar Sesión",
                ...
                TextButton(onClick = { }) { Text( "¿No tienes una cuenta? Regístrate",
                    color = Color.White ) }
                ...
                TextButton(onClick = { }) { Text( "¿Olvidó la contraseña?", color = Color.White )
                }
                ...
                Button( onClick = { /* TODO: Login action */ },
                    ...
                    colors = ButtonDefaults.buttonColors( containerColor = Color(0xFFDAD448),
                        contentColor = Color.White ) ) { Text("Ingresar", fontSize = 20.sp)
